...
with open(f'{os.getcwd()}/hangukInvestApi/api.txt', 'r', encoding='utf-8') as f:
    lines = f.readlines()
...
try:
    with open(f'{os.getcwd()}/hangukInvestApi/token.txt', 'r', encoding='utf-8') as f:
