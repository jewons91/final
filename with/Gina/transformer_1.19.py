...
def create_transformer_model(input_shape, num_heads, ff_dim, d_model, num_classes):
    ...
    pos_encoded_inputs = add_positional_encoding(inputs, max_len=input_shape[0], d_model=d_model)
...
model = create_transformer_model(input_shape, num_heads=1, ff_dim=128, d_model=X_train.shape[-1], num_classes=3)
