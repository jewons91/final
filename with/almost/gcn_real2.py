...
code = '000660_3'
# model_name = 'gcn변동률auc95'
# model_name = 'gcn전이하_삼'
# model_name = 'gcn전이하_삼_에'
# model_name = 'gcn전이하_삼_에_홀'
# model_name = 'gcn전이하_삼_에_홀_비'
# model_name = 'gcn전이하_삼_에_홀_비_현'
# model_name = 'gcn전이하_삼_에_홀_비_현_알'
# model_name = 'gcn전이하_삼_에_홀_비_현_알_한'
# model_name = 'gcn전이하_삼_에_홀_비_현_알_한_퓨'
# model_name = 'gcn전이하_삼_에_홀_비_현_알_한_퓨_D'
print(f'GPU available : {torch.cuda.is_available()}')
# name = 'SK하이닉스'
# 데이터 로드
df = pd.read_csv(f'C:/big18/dl-dev/dl-dev/project/변동률과 체결강도/{code}체결강도Vector.csv')
# df = df.iloc[:,2:]
...
# 학습 완료 후 최종 평가
model.load_state_dict(torch.load(f'C:/big18/dl-dev/dl-dev/project/변동률과 체결강도/{model_name}.pth'))
model.eval()
with torch.no_grad():
